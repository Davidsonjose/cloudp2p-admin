    ...
    <div className=' mb-2 lg:mb-6 relative'>
      <div className='flex justify-between items-center'>
        ...
        {props.label === "PASSWORD" && (
          <span className='text-xs font-semibold text-[#0A0E27]'>
            reset password?
          </span>
        )}
      </div>
      <input
        className={`appearance-none dark:placeholder-[#979797] placeholder:text-[14px] border border-gray-300 rounded-lg w-full py-3 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline ${props.className}`}
        {...props.register}
