...
function Input(props?: any) {
  ...
  return (
    <div className=" mb-2 lg:mb-6 relative">
      ...
      <input
        className={`appearance-none text-sm border border-gray-300 rounded-lg w-full py-3 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline ${props.className}`}
        {...props.register}
        placeholder={props.placeholder}
        max={props.type === "number" && props.limit === true && 11}
        type={props.type === "password" ? (show ? "password" : "text") : "text"}
